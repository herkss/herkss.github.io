...
이런 자료를 참고했어요.
[1] velog - 14. 플러터 Future, async, await (https://velog.io/@okvv26/14.-%ED%94%8C%EB%9F%AC%ED%84%B0-Future-async-await)
[2] velog - Flutter/Dart 에서의 Future, async/await (https://velog.io/@jintak0401/FlutterDart-%EC%97%90%EC%84%9C%EC%9D%98-Future-asyncawait)
[3] monocsp.dev - 4. Dart Flutter, 플러터의 비동기식 Future, await 그리고 async (https://monocsp.dev/8)
[4] 티스토리 - [Flutter] Future, async, await에 대해 알아보자 - Hac. Dog (https://baka9131.tistory.com/23) 
